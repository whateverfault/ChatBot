...
using System.Text;
using ChatBot.bot.services.translator.data.clients.Google.request;
using ChatBot.bot.services.translator.data.clients.Google.response;
using Newtonsoft.Json;

namespace ChatBot.bot.services.translator.data.clients.Google;
...
public class GoogleTranslateClient {
    ...
    public async Task<DetectLanguageResponse?> DetectLanguage(string text, EventHandler<string>? callback = null) {
        ...
        try {
            ...
            callback?.Invoke(this , $"Error while detecting a language. {e.Data}");
            return null;
        }
    }
    ...
    public async Task<TranslateTextResponse?> Translate(List<string> texts, string targetLanguage, string? sourceLanguage = null, EventHandler<string>? callback = null) {
        ...
        try {
            ...
            callback?.Invoke(this , $"Error while translating via google: {e.Data}");
            return null;
        }
    }
}