...
using ChatBot.bot.services.chat_commands.Parser.Data;

namespace ChatBot.bot.services.chat_commands.Parser;

public static class ChatCommandParser {
    public static Command? Parse(ChatMessage chatMessage) {
